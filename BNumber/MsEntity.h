...
public:
	...
	~CMsGroundParcel();
public:
	VMsGroundParcel GetGrountParcelDatas();//获取所有地面包裹数据
	void openGroundParcelById(DWORD nId);//打开包裹
	void getParcelItemData();//获取包裹物品
	void getPickupSpecificItemData(DWORD ItemObject);//获取指定的物品
private:
	//包裹
